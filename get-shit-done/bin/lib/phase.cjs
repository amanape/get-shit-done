...
const { escapeRegex, normalizePhaseName, comparePhaseNum, findPhaseInternal, getArchivedPhaseDirs, generateSlugInternal, getMilestonePhaseFilter } = require('./core.cjs');
const { planningDir, phasesDir: _phasesDir, roadmapPath: _roadmapPath, statePath: _statePath, phaseDir } = require('./utils/paths.cjs');
...
function cmdPhaseAdd(cwd, description, raw) {
  ...
  const dirPath = phaseDir(cwd, dirName);
